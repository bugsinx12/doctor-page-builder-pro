...
/**
 * Creates an authenticated Supabase client using a Clerk token via TPA
 * 
 * @param token JWT token from Clerk TPA
 * @returns Authenticated Supabase client
 */
export const getAuthenticatedClient = (token: string) => {
  console.log("Creating authenticated Supabase client with TPA token");
...
/**
 * Tests the TPA integration between Clerk and Supabase
 * @param token Clerk TPA token 
